...
@Slf4j
public class StockMarketClosedDaysRepositoryJdbc implements StockMarketClosedDaysRepository {
    private final NamedParameterJdbcTemplate template;

    public StockMarketClosedDaysRepositoryJdbc(DataSource dataSource) {
